...
class _ClassFormState extends State<ClassForm> {
  ...
  void initState() {
    ...
    _classroomController = TextEditingController(text: widget.classData['classroom']);
    selectedType = widget.classData['type'];
    dropdownDay = widget.classData['day'];
    docId = widget.classData['docId'];
    
    // Convert minutes to TimeOfDay
    final startMinutes = widget.classData['startTime'] as int;
    final endMinutes = widget.classData['endTime'] as int;
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      for (final doc in querySnapshot.docs) {
        // Skip checking against the current document
