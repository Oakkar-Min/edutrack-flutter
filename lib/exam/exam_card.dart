              ...
              children: [
                TextButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pushNamed(context, '/edit_exam', arguments: examId);
                  },
                  child: const Text(
                    "Edit",
                    style: TextStyle(
                  ...
                  onPressed: () async {
                    final confirm = await showDialog<bool>(
                      ...
                      builder: (_) => AlertDialog(
                        ...
                        content: const Text("Are you sure you want to delete this exam?", style: TextStyle(color: Colors.white70)),
                        actions: [
                          TextButton(
